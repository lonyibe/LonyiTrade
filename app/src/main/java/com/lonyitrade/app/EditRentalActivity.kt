...
class EditRentalActivity : AppCompatActivity() {
    ...
    private fun populateFields() {
        // Find the index of the property type from the spinner adapter
        val propertyTypePosition = (propertyTypeSpinner.adapter as ArrayAdapter<String>).getPosition(rental.propertyType)
        ...
        rentalLocationDescEditText.setText(rental.locationDescription)
        rentalRentEditText.setText(rental.monthlyRent?.toString() ?: "")
        landlordNameEditText.setText(rental.landlordName)
        landlordPhoneEditText.setText(rental.landlordPhone)
        landlordEmailEditText.setText(rental.landlordEmail)
        landlordWhatsappEditText.setText(rental.landlordWhatsapp)

        selectRadioButton(rentalPriceTypeRadioGroup, rental.priceType)
        selectRadioButton(landlordTypeRadioGroup, rental.landlordType)
    }
    ...
    private fun handleUpdate() {
        ...
        val rentalRequest = RentalRequest(
            propertyType, city, district, rooms, locationDesc, monthlyRent, priceType, rules, description, landlordName, landlordPhone, landlordEmail, landlordWhatsapp, landlordType
        )
